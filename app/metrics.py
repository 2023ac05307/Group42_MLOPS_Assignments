...
PREDICTIONS_TOTAL = Counter("model_predictions_total", "Number of predictions served")

INFERENCE_SECONDS = Histogram("model_inference_seconds", "Model inference latency (s)")
